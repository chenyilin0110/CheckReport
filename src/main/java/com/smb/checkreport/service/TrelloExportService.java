...
public class TrelloExportService {
    ...
    public List<ExportToCSV> getTrelloDT(HttpServletRequest request, JSONObject returnJson, Integer previous, String needUpdateCheckItemsId, String checkItemsStatus) throws IOException, ParseException {
